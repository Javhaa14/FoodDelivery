    ...
    <div
      ...
      <div
        ...
        <motion.div
          ...
          <div className="group relative text-[14px] h-auto">
            <p>{food} foods</p>
            <div className="hidden group-hover:flex w-[263px] max-h-[400px] h-fit overflow-scroll flex-col items-start gap-3 top-[-10] absolute left-15 bg-white text-[#09090B] p-3 rounded-md shadow-lg z-50 border-[1px] border-[#18181b]">
