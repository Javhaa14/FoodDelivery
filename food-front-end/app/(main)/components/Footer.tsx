      ...
      <div className="flex w-full px-10 justify-between items-start">
        ...
        <div className="flex items-start gap-[112px]">
          ...
          <div className="flex items-start gap-[56px]">
            <div className="flex w-[132px] flex-col items-start gap-4 text-[16px] text-white">
            ...
            <div className="flex w-[132px] flex-col items-start gap-4">
              <p className="text-[#18181B]">o</p>
              <p>Side dish </p>
              <p>Brunch</p>
              <p>Desserts</p>
              <p>Beverages</p>
